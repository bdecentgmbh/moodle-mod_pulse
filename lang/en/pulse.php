...
$string['courselink_template'] = '<a href="{$a->url}" target="_blank" rel="noopener noreferrer" aria-label="{$a->aria}">{$a->text}</a>';
...
$string['opencourseinnewtab'] = 'Open course page in a new tab';
