...
$string['detailedlog'] = 'Display the cron logs in detailed';
$string['showhide'] = 'Show/Hide';
$string['configintro'] = 'Below configs are applied by default to the new pulse activity';
$string['tasklimituser'] = 'Limit user record task progress count.';
$string['tasklimituserdesc'] = 'Limit the user records fetch progress when the task runs.';
