...
Feature: View activity completion information in the pulse activity
  ...
  @javascript
  Scenario: Pulse view automatic completion items
  ...
  Scenario: Use manual completion Required by approval complete.
    ...
    And I click on "Test pulse 1" "text" in the ".activity-altcontent" "css_element"
    ...
    And I am on "Course 1" course homepage
    And I should see "Test pulse 1"
    And "Test pulse 1" should have the "Approved on" completion condition type "done"
